const {
  ...
  task("request-checkin", "Initiates an on-demand request from a Functions consumer contract, but specifically the checkin contract")
    ...
    .setAction(async (taskArgs, hre) => {
      ...
      const consumerFactory = await ethers.getContractFactory("SimpleRentCheckin")
